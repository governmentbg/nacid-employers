...
namespace Resc.Data.Users
{
    public class User
    {
		...
		public void Update(string username, string email, string phone, string firstName, string middleName, string lastName, int roleId, string position, int? institutionId)
		{
			this.Username = username;
			this.Email = email?.Trim().ToLower();
			this.Phone = phone;
